...
# TRAIN_DATA=/mnt/pfs_l2/jieti_team/SFT/hupeng/data/en/audio_detect/train/ad_train_softmax_semantic_codes.json
...
cp /mnt/pfs_l2/jieti_team/SFT/hupeng/github/wts/run_train.sh "$OUTPUT_DIR"/run_train.sh