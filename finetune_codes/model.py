...
class KimiAudioModel(MoonshotKimiaForCausalLM):
    def __init__(self, config):
        ...
        self.whisper_model = WhisperEncoder("/mnt/pfs_l2/jieti_team/SFT/hupeng/resources/llm-base-models/Kimi-Audio-7B/whisper-large-v3", mel_batch_size=20, unfreeze_online_whisper_model=True)
    ...
    def export_model(input_dir, output_dir):
        ...
        whisper_model = WhisperModel.from_pretrained("/mnt/pfs_l2/jieti_team/SFT/hupeng/resources/llm-base-models/Kimi-Audio-7B/whisper-large-v3")
    ...
    def forward(
        ...
        if whisper_input_feature is not None and whisper_input_feature.numel() > 0:
            whisper_input_feats = whisper_input_feature.to(input_ids.device)
